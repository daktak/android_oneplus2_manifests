...
unifiednlp_build := $(unifiednlp_root)/$(unifiednlp_dir)/build
unifiednlp_apk   := build/outputs/apk/$(unifiednlp_dir)-release-unsigned.apk

$(unifiednlp_root)/$(unifiednlp_dir)/$(unifiednlp_apk):
...
LOCAL_SRC_FILES := $(unifiednlp_dir)/$(unifiednlp_apk)
